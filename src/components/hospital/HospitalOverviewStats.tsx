    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
      ...
      <Card className="flex items-center justify-between">
        <div>
          ...
          <p className="text-2xl font-extrabold font-heading text-[#0837ad] dark:text-blue-400 mt-1">
            {referralCount}
          </p>
        </div>
        <div className="p-3 bg-blue-50 dark:bg-slate-800 text-[#0837ad] dark:text-blue-400 rounded-xl">
      ...
      <Card className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm font-bold text-sky-600 dark:text-sky-400 mt-2 flex items-center gap-1">
