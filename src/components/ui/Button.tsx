...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const variants = {
      primary: 'bg-[#0837ad] text-white hover:bg-[#062c8d] focus:ring-[#0837ad] shadow-md shadow-blue-900/10',
      secondary: 'bg-[#052370] text-white hover:bg-[#041d63] focus:ring-[#052370]',
      navy: 'bg-[#0837ad] text-white hover:bg-[#062c8d] focus:ring-[#0837ad]',
      outline: 'border border-[#0837ad] text-[#0837ad] dark:text-blue-200 dark:border-blue-400 hover:bg-blue-50/60 focus:ring-[#0837ad]',
      ghost: 'text-[#0837ad] dark:text-slate-200 hover:bg-blue-50/60 dark:hover:bg-slate-800 shadow-none',
      danger: 'bg-slate-800 text-white hover:bg-slate-900 focus:ring-slate-700',
    };
