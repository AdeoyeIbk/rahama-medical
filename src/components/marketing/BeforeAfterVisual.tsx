            ...
            {activeTab === 'BEFORE' ? (
              ...
              >
                <div className="text-center max-w-xl mx-auto mb-2">
                  <span className="text-xs font-bold text-red-600 uppercase tracking-widest flex items-center justify-center gap-1.5">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
                  <div className="bg-slate-50 p-8 rounded-3xl border border-slate-200/80 card-soft-shadow text-center space-y-3">
                    <div className="w-12 h-12 rounded-2xl bg-red-50 border border-red-100 flex items-center justify-center mx-auto text-red-500">
                    ...
                    <span className="text-xs font-semibold text-red-600 block pt-1">
                      Records Stay Behind
                    </span>
                  </div>
                ...
                <p className="text-xs sm:text-sm text-center text-red-600 font-medium">
              ...
              >
                <div className="text-center max-w-xl mx-auto mb-2">
                  <span className="text-xs font-bold text-[#0837ad] uppercase tracking-widest flex items-center justify-center gap-1.5">
                    <Shield className="w-4 h-4 text-emerald-500" /> The Rahama Connected Network
                  </span>
                </div>

                {/* Patient Hub at Center */}
                <div className="flex flex-col items-center">
                  <div className="bg-gradient-to-br from-[#0837ad] to-[#041d63] text-white p-7 rounded-3xl shadow-2xl shadow-blue-900/20 text-center max-w-md w-full relative border border-blue-400/30">
                    <img
                      src="/amina-avatar.jpg"
                      alt="Amina Ibrahim Bello"
                      className="w-16 h-16 rounded-full object-cover border-2 border-orange-400 mx-auto mb-3 shadow-md"
                    />
