...
export default function SolutionPage() {
  ...
  const [homeHospitalId, setHomeHospitalId] = useState<string | null>(
    "hosp-001",
  );
  ...
  const architectureLayers = [
    ...
    },
    {
      ...
      benefits: [
        "Hospitals keep their existing software with no retraining needed",
  ...
  const caseStudies = [
    {
      ...
      scenario:
        "A patient is involved in a road traffic incident in Ikeja and rushed to an urgent care clinic, then quickly transferred to a tertiary teaching hospital.",
      traditionalIssue:
        "Paper records are delayed or lost in transit. The trauma surgical team has zero knowledge of the patient’s severe penicillin allergy or blood type.",
      rahamaSolution:
        "The admitting trauma team scans the patient’s Rahama digital card. Within seconds, emergency blood typing, active medications, and allergy warnings are displayed on the clinical console.",
    ...
    },
    {
      ...
      scenario:
        "A patient living with Type 2 Diabetes and Hypertension visits an endocrinologist in Lagos, a cardiologist in Abuja, and a local family clinic.",
      traditionalIssue:
        "Each physician works with isolated partial records. The patient spends tens of thousands of Naira repeating HbA1c and lipid panel tests every few months.",
      rahamaSolution:
        "All diagnostic labs and specialist prescription logs sync to one lifelong timeline. Both specialists review the exact same medication history and avoid redundant laboratory testing.",
    ...
    },
    {
      ...
      scenario:
        "An expectant mother receives antenatal care at a private clinic, but goes into sudden premature labor while visiting relatives in another state.",
      traditionalIssue:
        "The new hospital has no access to her gestational age scans, prenatal serology tests, or previous cesarean surgical notes.",
      rahamaSolution:
        "The labor ward doctor requests instant access via the mother’s Rahama ID. With one tap on her phone, complete antenatal monitoring history is immediately available.",
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white selection:bg-[#0837ad] selection:text-white">
      ...
      <main className="flex-grow">
        ...
        <section className="bg-gradient-to-b from-[#0837ad] via-[#0935a3] to-[#052370] text-white py-24 sm:py-32 relative overflow-hidden">
          ...
          <div className="max-w-[1600px] mx-auto px-6 sm:px-16 lg:px-32 relative z-10 text-center space-y-6">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold font-heading text-white tracking-tight leading-tight">
              ...
              <span className="text-blue-200">Total Control.</span>
            </h1>
            <p className="text-base sm:text-xl text-blue-100/90 max-w-3xl mx-auto leading-relaxed">
              Rahama is the digital health interoperability highway connecting
              hospitals, clinics, and diagnostic labs across Africa, ensuring
              medical records follow the patient safely wherever care is needed.
            </p>
        ...
        <section
          id="architecture"
          className="py-24 sm:py-32 bg-white text-slate-900 transition-colors"
        >
          <div className="max-w-[1600px] mx-auto px-6 sm:px-16 lg:px-32">
            <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold font-heading text-slate-900 tracking-tight leading-tight">
                ...
                <span className="text-[#0837ad]">
                  the entire continuum of care.
                </span>
              </h2>
              <p className="text-base sm:text-lg text-slate-600 leading-relaxed max-w-2xl mx-auto">
                Rahama connects hospitals without replacing their existing
                software. Our three-layer architecture ensures security, speed,
                and absolute patient consent.
              </p>
            </div>
        ...
        <section className="py-24 sm:py-32 bg-white text-slate-900 transition-colors">
          <div className="max-w-[1600px] mx-auto px-6 sm:px-16 lg:px-32">
            <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
              ...
              <p className="text-base sm:text-lg text-slate-600 leading-relaxed max-w-2xl mx-auto">
                Explore how Rahama eliminates dangerous information gaps across
                typical real-world medical encounters.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
              {caseStudies.map((cs, idx) => (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  transition={{ duration: 0.4, delay: idx * 0.1 }}
                  className="bg-[#f8fafc] p-6 sm:p-7 lg:p-8 rounded-3xl border border-slate-200/80 card-soft-shadow hover:shadow-xl hover:border-blue-200 transition-all duration-300 flex flex-col justify-between"
                >
                  <div className="space-y-4">
                    ...
                    <div className="space-y-3 text-xs sm:text-sm">
                      ...
                      <div className="p-3.5 rounded-2xl bg-blue-50 border border-blue-100 text-slate-700">
                        <strong className="block text-[#0837ad] font-semibold mb-1">
                          With Rahama Connected:
                        </strong>
                        {cs.rahamaSolution}
                      </div>
                    </div>
          ...
          <div className="max-w-6xl mx-auto rounded-[36px] sm:rounded-[44px] bg-gradient-to-br from-[#0837ad] via-[#0b3dc4] to-[#041d63] text-white p-8 sm:p-12 lg:p-16 text-center space-y-8 shadow-2xl shadow-blue-900/15 border border-blue-400/20 relative overflow-hidden">
            ...
            <div className="relative z-10 max-w-3xl mx-auto space-y-6">
              ...
              <p className="text-base sm:text-lg text-blue-100/90 leading-relaxed max-w-2xl mx-auto">
                Join forward-thinking hospitals, diagnostic clinics, and health
                systems across Nigeria. Secure integration takes less than one
                week.
              </p>
