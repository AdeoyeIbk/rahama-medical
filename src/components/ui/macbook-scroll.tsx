...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="flex min-h-[140vh] shrink-0 scale-[0.35] transform flex-col items-center justify-start py-0 [perspective:800px] sm:scale-50 md:scale-100 md:py-32"
    >
      <motion.h2
        style={{
        ...
        className="mb-12 text-center text-3xl font-bold font-heading text-neutral-800 dark:text-white"
      >
        {title || (
          <span>
            Patient Records Following Care. <br /> Connected Infrastructure.
          </span>
        )}
      </motion.h2>
      {/* Lid */}
...
export const Lid = ({
  ...
  return (
    <div className="relative [perspective:800px]">
      ...
      >
        <div className="absolute inset-0 rounded-lg bg-[#00004d]" />
        {children ? (
          <div className="absolute inset-0 h-full w-full overflow-hidden rounded-lg bg-slate-950 p-2">
            {children}
          </div>
        ) : src ? (
          <img
            src={src}
            alt="Rahama Record Screen"
